...
def getUIContent():
   ...
   my_toolProperty.TitleText = "  Create lap joint"
...
def getCustomToolPropertyContent():
   ...
   horizThickLbl.Text = "    Lower plate thickness (mm):"
   ...
   vertThickLbl.Text = "    Upper plate thickness (mm):"
...
def BuildJoint(sender, args):
   ...
   apex_sdk.runScriptFunction(file=script_path, function="buildLapJoint", args=dictionary)
